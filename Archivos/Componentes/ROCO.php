...
<body>
    ...
    <h1 class="titulo-preparatoria">Reconocimiento Oficial de la Competencia Ocupacional (ROCO)</h1>
    ...
    <section class="info-preparatoria container">
        <div class="contenedor-info get-started">
            ...
            <div class="contenedor-flex">
                <p class="texto-preparatoria">*Está enfocado en certificar mediante la expedición oficial de un Diploma de tus conocimientos,
                    <br>
                    <br>
                    * habilidades, destrezas y actitudes correspondientes a una competencia ocupacional, sin importar cómo fueron adquiridos éstos, previa aprobación de un examen teórico - práctico, que avalan el saber hacer.
                </p>
                <img class="img-prepa" src="imagenes/reconocimiento-ROCO.JPG" alt="">
            </div>
        </div>
    </section>
